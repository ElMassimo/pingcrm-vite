<template>
  <div v-if="show">
    ...
    >
      ...
      >
        <svg
          class="block w-2 h-2 fill-green-800 group-hover:fill-green-700"
          xmlns="http://www.w3.org/2000/svg"
          width="235.908"
          height="235.908"
    ...
    >
      ...
      >
        <svg
          class="block w-2 h-2 fill-red-800 group-hover:fill-red-800"
          xmlns="http://www.w3.org/2000/svg"
          width="235.908"
          height="235.908"
          viewBox="278.046 126.846 235.908 235.908"
    ...
    >
      ...
      >
        <svg
          class="block w-2 h-2 fill-red-600 group-hover:fill-red-700"
          xmlns="http://www.w3.org/2000/svg"
          width="235.908"
          height="235.908"
          viewBox="278.046 126.846 235.908 235.908"
